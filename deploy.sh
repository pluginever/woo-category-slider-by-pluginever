#! /bin/bash
# ----- START EDITING HERE -----
PLUGINSLUG="woo-category-slider"
SVNUSER="manikmist09"
# ----- STOP EDITING HERE -----
...
SVNURL="https://plugins.svn.wordpress.org/woo-category-slider-by-pluginever"
...
if [ $(echo "$PROCEED" | tr [:upper:] [:lower:]) == "y" ]; then
	...
	svn cp -m"tagging v$VERSION" https://plugins.svn.wordpress.org/woo-category-slider-by-pluginever/trunk https://plugins.svn.wordpress.org/woo-category-slider-by-pluginever/tags/$VERSION
else
	warning "Aboring tag..."
fi
